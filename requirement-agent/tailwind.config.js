...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Agent 1 identity: deep navy/indigo — judgment, gatekeeping,
        // "this passed review." Deliberately desaturated and serious
        // rather than the brighter purple used before, to read as
        // enterprise tooling rather than a consumer app.
        brand: {
          50:  "#EEF1F8",
          100: "#DCE2F0",
          200: "#B6C2DF",
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, #17223E 0%, #283A68 55%, #445A82 100%)",
